...
df_ss <- df %>%
  ...
  mutate(
    ...
    samenredzaam_ss = mean(c(
      wl03_1_cross_wei,
      # wl11_0_cross_wei,
      wl12_0_cross_wei, wl13_cross_wei, zw06_1_cross_wei, zw10_1_cross_wei
    ), na.rm = TRUE) * (10 / 4),
    ...
    voorzieningen_ss = mean(c(
      vz01_0_wei,
      # vz01_1_wei,
      vz03_5_wei, vz03_6_wei,
      vz03_0_wei, vz03_1_wei, vz03_2_wei, vz03_3_wei, vz03_4_wei
    ), na.rm = TRUE) * (35 / 14),
    ...
    betrouwbaar_ss = mean(c(
      bo02_0_wei, bo02_1_wei, bo02_2_wei, bo03_0_wei, bo03_1_wei,
      # bo04_0_wei,
      wl12_0_wei, wl12_2_wei
    ), na.rm = TRUE) * (10 / 4),
